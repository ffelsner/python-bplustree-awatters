...
class Node:
    ...
    def delnode(self, key):
        ...
        if self.validkeys < 0:
            raise KeyError("no such key (empty)")
    ...
    def getnode(self, key):
        ...
        if place < 0:
            raise IndexError("invalid position! " + repr((place, key)))
    ...
    def free(self, freenodeposition):
        """
        add self to free list, return position as new free position
        """
        self.flag = Freeflag
        ...
        if node.flag in Interiorflags:
            ...
            if (size < half):
                ...
                if lki > nodesize or (leftnode.flag != Leafflag and lki >= nodesize):
                    ...
                    if (leftkey is not None and leftkey != newleftkey):
